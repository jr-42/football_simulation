...
class Player:
    ...
    def __init__(self):
        ...
        self.__dob = int((datetime(datetime.now().year-30, 1, 1) + \
            int(365*random.uniform(-3.0, 10.0)) * timedelta(days=1)).strftime('%Y%m%d'))
        ...
        # self.__value = (self.__ca/100 + self.__fa/100 + (33-self.age)/100.0) * 1000
